...
void generateReport(vector<double> withdrawals, vector<double> deposits, double initBal, double bal, double interest){
	...
	double totDep = 0;
	cout << "\n**********Monthly Report**********\n";
	cout << "The initial balance is: $" << initBal << "\n" << endl;
	...
	cout << "\n";
	cout << "The total amount of withdrawals is: $" << totWith << "\n" << endl;
	...
	cout << "\n";
	cout << "The total amount of deposits is: $" << totDep << "\n" << endl;
	cout << "The ending balance is: $" << bal << "\n" << endl;
	cout << "The interest accrued is: $" << interest << "\n" << endl;
	cout << "The balance with interest is: $" << bal + interest << "\n" << endl;
...
void readData(vector<double> &w, vector<double> &d, double &iB){
	...
	while (-1 != value){
		cout << "Enter the withdrawls (Enter \"-1\" to stop): " << endl;
		cin >> value;
	...
	while (-1 != value){
		cout << "Enter the deposits (Enter \"-1\" to stop): " << endl;
		cin >> value;
		if (!cin || (value<0 && -1 != value)){
			isIncorrect();
		}
